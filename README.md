...
## Environments
- Preview: https://main--franklin-demo--etomaello.hlx.page/
- Live: https://main--franklin-demo--etomaello.hlx.live/
...
WKND_URL=https://main--franklin-demo--etomaello.hlx.live ITERATIONS=1000 npm run generate-traffic
```
